...
namespace Demo.Tests
{
    public class AssertingCollectionsTests
    {
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Giovani", 10000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Giovani", 1000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Giovani", 15000);
